...
- (void)setupScrollView
{
    ...
    for (int i = 0; i<HMNewfeatureImageCount; i++) {
        ...
        NSString *name = [NSString stringWithFormat:@"firststartimg%d", i + 1];
...
//        }
    ...
    scrollView.backgroundColor = YWColor(246, 246, 246);
...
- (void)setupPageControl
{
    ...
    // 2.设置圆点的颜色
    pageControl.currentPageIndicatorTintColor = YWColor(253, 98, 42); // 当前页的小圆点颜色
    pageControl.pageIndicatorTintColor = YWColor(189, 189, 189); // 非当前页的小圆点颜色
...
- (void)setupStartButton:(UIImageView *)imageView
{
    ...
    startButton.frame = imageView.bounds;
...
- (void)start
{
    ...
    YWTabbarController *vc = [[YWTabbarController alloc] init];
