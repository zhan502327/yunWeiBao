...
@interface LMStarView ()

/**类型*/
@property (nonatomic,assign)  LMStarType starType;
/**尺寸*/
...
@implementation LMStarView

- (instancetype)initWithFrama:(CGRect)frame starSize:(CGSize)starSize withStyle:(LMStarType)style
{
...
- (void)initView
{
    ...
    if (self.starType == LMKStarTypeInteger)
    {
        for (int i = 0; i < 5; i++)
        {
